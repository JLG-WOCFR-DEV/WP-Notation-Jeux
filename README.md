...
- **Game Explorer & Score Insights** : `[jlg_game_explorer]` propose une navigation filtrable accessible (GET), panneaux responsives et focus géré ; `[jlg_score_insights]` calcule moyenne/médiane, histogramme, podium plateformes, indicateur de tendance et label de consensus (écart-type + fourchette) sur une période configurée.
